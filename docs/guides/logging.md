...
Kawasaki ETL provides comprehensive logging capabilities with structured logging and multiple output formats.
...
```
2025-01-20 12:00:00 [INFO] kawasaki_etl.app: Application started component=Application
```
