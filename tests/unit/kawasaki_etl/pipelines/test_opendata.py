...
from kawasaki_etl.configs import OPEN_DATA_PAGES
...
@pytest.mark.parametrize("page", list(OPEN_DATA_PAGES))
...
def test_download_opendata_page(
    page: OpenDataPage, monkeypatch: pytest.MonkeyPatch, tmp_path: Path,
) -> None:
    ...
    expected_filenames = {
        resource.filename for resource in page.resources
    }
