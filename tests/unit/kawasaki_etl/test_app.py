...
class TestApplication:
    ...
    @patch("kawasaki_etl.app.load_dotenv")
    @patch("kawasaki_etl.app.configure_logging")
    @patch("kawasaki_etl.app.get_logger")
    @patch("kawasaki_etl.app.get_settings")
    @patch("kawasaki_etl.app.get_interface_settings")
    @patch("kawasaki_etl.app.InterfaceFactory")
...
def test_create_app() -> None:
    ...
    with patch("kawasaki_etl.app.Application") as mock_app_class:
        mock_app = MagicMock()
...
def test_run_app() -> None:
    ...
    with patch("kawasaki_etl.app.create_app") as mock_create_app:
        mock_app = MagicMock()
